...
public class ArchitectureCRAPackageImpl extends EPackageImpl implements ArchitectureCRAPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getClass_Encapsulates(), this.getFeature(), this.getFeature_IsEncapsulatedBy(), "encapsulates", null, 0, -1, architectureCRA.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
