...
public abstract class FeatureImpl extends NamedElementImpl implements Feature {
	 ...
	 * @ordered
	 */
	protected EList<architectureCRA.Class> isEncapsulatedBy;
	 ...
	 * @generated
	 */
	public EList<architectureCRA.Class> getIsEncapsulatedBy() {
		if (isEncapsulatedBy == null) {
			isEncapsulatedBy = new EObjectWithInverseResolvingEList.ManyInverse<architectureCRA.Class>(architectureCRA.Class.class, this, ArchitectureCRAPackage.FEATURE__IS_ENCAPSULATED_BY, ArchitectureCRAPackage.CLASS__ENCAPSULATES);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ArchitectureCRAPackage.FEATURE__IS_ENCAPSULATED_BY:
				...
				getIsEncapsulatedBy().addAll((Collection<? extends architectureCRA.Class>)newValue);
				return;
		}
