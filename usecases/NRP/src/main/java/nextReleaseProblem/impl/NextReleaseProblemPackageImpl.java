...
public class NextReleaseProblemPackageImpl extends EPackageImpl implements NextReleaseProblemPackage {
	...
	public static NextReleaseProblemPackage init() {
		...
		Object registeredNextReleaseProblemPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		NextReleaseProblemPackageImpl theNextReleaseProblemPackage = registeredNextReleaseProblemPackage instanceof NextReleaseProblemPackageImpl ? (NextReleaseProblemPackageImpl)registeredNextReleaseProblemPackage : new NextReleaseProblemPackageImpl();
	 ...
	 * @generated
	 */
	public EAttribute getNRP_Budget() {
		return (EAttribute)nrpEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSolution_TotalCosts() {
	...
	public void createPackageContents() {
		...
		createEAttribute(nrpEClass, NRP__BUDGET);
		...
		createEAttribute(solutionEClass, SOLUTION__TOTAL_COSTS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNRP_Budget(), ecorePackage.getEDouble(), "budget", null, 1, 1, nextReleaseProblem.NRP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCustomer_Importance(), ecorePackage.getEDouble(), "importance", null, 1, 1, Customer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCost_Amount(), ecorePackage.getEDouble(), "amount", null, 1, 1, Cost.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRequirementRealisation_Percentage(), ecorePackage.getEDouble(), "percentage", "1.0", 1, 1, RequirementRealisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSolution_TotalCosts(), ecorePackage.getEDouble(), "totalCosts", "0", 1, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getValuation_Value(), ecorePackage.getEDouble(), "value", null, 1, 1, Valuation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
