...
public interface NextReleaseProblemPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the attribute '{@link nextReleaseProblem.NRP#getBudget <em>Budget</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Budget</em>'.
	 * @see nextReleaseProblem.NRP#getBudget()
	 * @see #getNRP()
	 * @generated
	 */
	EAttribute getNRP_Budget();
	...
	/**
	 * Returns the meta object for the attribute '{@link nextReleaseProblem.Solution#getTotalCosts <em>Total Costs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Total Costs</em>'.
	 * @see nextReleaseProblem.Solution#getTotalCosts()
	 * @see #getSolution()
	 * @generated
	 */
	EAttribute getSolution_TotalCosts();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute NRP__BUDGET = eINSTANCE.getNRP_Budget();
		 ...
		 * @generated
		 */
		EAttribute SOLUTION__TOTAL_COSTS = eINSTANCE.getSolution_TotalCosts();
